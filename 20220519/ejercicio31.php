    ...
    <input value="<?php echo $txtNombre;?>" type="text" name="txtNombre" id="">
     ...
     <br/>
      ...
      <select name="lsAnime" id="">
          ...
          <option value="naruto" <?php echo ($lsAnime=="naruto")?"selected":""; ?> >dragon ball z</option>
          <option value="bleach" <?php echo ($lsAnime=="bleach")?"selected":""; ?> >death note</option>
          <option value="dragon" <?php echo ($lsAnime=="dragon")?"selected":""; ?> >jujutsu kaisen</option>
